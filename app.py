...
평소 {nickname}님께서 보여주시는 감각적인 뷰티 무드가 저희 멜브 제품과 완벽한 시너지를 낼 수 있을 것이라 판단하여, 상호 윈윈할 수 있는 커머스 파트너십을 제안드립니다.

**[브랜드 및 제품 경쟁력]**
저희 멜브는 '카카오톡 선물하기 뷰티 랭킹 1위'를 달성하며 대중적인 인지도와 압도적인 구매 전환율이 이미 데이터로 입증된 브랜드입니다. 

- 주력 제품: 립시럽(맑은 유리알 광택), 립타투(24시간 지속력/뮤티드 컬러/오버립)
- 제품 확인: https://a-bly.com/app/markets/108879/

**[협업 제안 내용]**
이미 확실한 수요가 존재하는 제품인 만큼, {nickname}님과 전용 링크를 통한 판매 수익 쉐어(RS) 공동구매를 진행하고 싶습니다.

혹시 일정상 본격적인 공동구매를 진행하는 것이 부담스러우시다면, 인스타그램 프로필이나 게시물 하단에 '단독 최저가 링크'만 가볍게 걸어두시는 방식도 추천해 드립니다. 운영 방식은 쿠팡 파트너스와 동일하지만 수수료율은 브랜드 직영인 만큼 훨씬 높게 책정되어 있습니다. 콘텐츠 무드를 해치지 않으면서도 1위 제품의 실질적인 전환 수익을 챙기실 수 있는 구조입니다. :)

관련하여 수수료율 등 궁금하신 점이 있으시면 편하게 회신 부탁드립니다.
감사합니다.
박혜란 드림"""
        },
        'seeding': {
...
평소 {nickname}님의 콘텐츠와 독보적인 무드를 즐겨 보고 있었습니다. 저희 브랜드가 지향하는 이미지와 분위기가 정말 잘 어우러질 것 같아, 이번 제품을 꼭 보내드리고 싶어 연락드렸습니다. 
...
본 시딩은 제품을 받아보시고 {nickname}님만의 감성으로 인스타그램에 게시물/릴스를 1회 가볍게 업로드해 주시는 일정입니다. 아낌없이 전 컬러를 꽉 채워 보내드리겠습니다. 

더불어 업로드해 주실 때, 정보를 궁금해할 구독자분들을 위해 '전용 최저가 수익 링크'도 함께 발행해 드릴 수 있습니다. 본문이나 프로필에 링크만 걸어두시면 판매 시 쿠팡 파트너스보다 훨씬 높은 브랜드 직영 수수료를 정산해 드립니다. 올리시는 예쁜 콘텐츠에 실질적인 수익(리워드)도 함께 챙겨가셨으면 좋겠습니다! :) 

진행이 가능하시다면 받아보실 [성함 / 연락처 / 주소]를 남겨주세요. 정성껏 포장해서 보내드리겠습니다.
감사합니다!
박혜란 드림"""
        }
    },
...
{nickname}님의 맑 뷰티 무드를 인상 깊게 보며, 저희 솔브와 최고의 시너지를 낼 수 있을 것이라 확신하여 수익 쉐어형 커머스 파트너십을 제안드립니다.

**[브랜드 및 제품 경쟁력]**
저희 '솔브 더블세럼 모델링팩'은 론칭 직후 입소문만으로 1만 개 수량이 전량 완판되어 현재 대기 예약으로만 판매되고 있는 폭발적인 수요의 대란템입니다. 

- 특장점: 물 조절 필요 없는 3초 컷 홈에스테틱, 화잘먹 윤광 코팅
- 제품 확인: https://solv.co.kr/aboutus/productstory.html

**[협업 제안 내용]**
이미 고객들의 엄청난 수요가 확인된 제품이기에, {nickname}님과 전용 링크를 통한 수익 쉐어(RS) 방식의 공동구매를 최우선으로 제안드리고 싶습니다.

다만 일정상 본격적인 공구 진행이 부담스러우시다면, 인스타그램 프로필이나 게시물 하단에 '단독 최저가 링크'만 가볍게 걸어두시는 방식도 함께 제안해 드립니다. 

운영 방식은 쿠팡 파트너스와 같지만, 본사 직영이라 수수료율이 훨씬 높습니다. 완판 대란템인 만큼 링크 하나만으로도 콘텐츠 무드를 해치지 않으며 실질적인 높은 수익을 확보하실 수 있습니다. :)

궁금하신 사항이나 논의할 부분이 있으시면 편하게 회신 부탁드립니다.
감사합니다.
박혜란 드림"""
        },
        'seeding': {
...
{nickname}님 특유의 맑은 분위기와 피부결이 저희 솔브(SOLV)와 만나면 최고의 시너지가 날 것 같아 제품 시딩(협찬)을 제안드립니다.

**[제공 제품: 1만 개 전량 완판 대란템]**
1차 물량은 전량 완판되어 예약 판매 진행할 정도로 인기있는 아이템이며, {nickname}님을 위해 넉넉하게 준비했습니다.

- 솔브 더블세럼 모델링팩: 번거로운 물 조절 없이 1제와 2제 세럼을 섞어 쓰는 시원한 쿨링 젤리팩
- https://solv.co.kr/aboutus/productstory.html

이번 시딩은 제품을 직접 넉넉히 경험해 보시고, 인스타그램(피드 또는 릴스)에 제품 판매 링크 삽입, 솔브 계정(@solv.kr) 태그 1회 가볍게 업로드해 주시는 일정입니다. 🩵

더불어 업로드하실 때 쏠쏠한 혜택을 보실 수 있도록 '전용 최저가 수익 링크'도 함께 발행해 드릴 수 있습니다. 본문이나 프로필에 링크만 걸어두시면 판매 시 쿠팡보다 훨씬 높은 브랜드 직영 수수료를 정산해 드립니다. 올리시는 예쁜 게시물에 실질적인 현금성 리워드도 꼭 챙겨가셨으면 좋겠습니다! :)
...
평소 보여주시는 독보적인 아웃핏과 스타일링 감각에 반해, 저희 브랜드와 최고의 시너지를 낼 수 있을 것이라 확신하여 수익 쉐어형(RS) 파트너십을 제안드립니다. 

**[브랜드 및 제품 경쟁력]**
저희 어퍼(UPPR)의 주력 제품은 패션 고관여 고객들 사이에서 '핏 보장템'으로 불리며 높은 구매 전환율을 기록하고 있습니다. 

- **볼캡:** 광대와 두상을 완벽하게 커버하는 소두핏 연출
- **시그니처 체크셔츠:** 볼캡과 찰떡궁합인 감각적인 오버핏 꾸안꾸룩
- **골반뽕 부츠컷 데님팬츠**: 골반라인 살려주는 부츠컷 데님팬츠
- 제품 확인: https://smartstore.naver.com/uppr

**[협업 제안 내용]**
{nickname}님의 데일리룩에 저희 제품을 녹여내어, 전용 판매 링크를 통한 수익 쉐어(RS) 커머스를 진행해 보고자 합니다. 워낙 핏이 좋으셔서 팬분들의 반응이 뜨거울 것으로 기대합니다.

혹시 캘린더 일정상 본격적인 공동구매 진행이 부담스러우시다면, 인스타그램 프로필 링크나 게시물 하단에 '단독 최저가 링크'만 가볍게 걸어두시는 방식도 함께 제안해 드립니다.

운영 방식은 쿠팡 파트너스와 동일하지만, 저희 브랜드 직영인 만큼 수수료율은 훨씬 높게 책정되어 있습니다. 게시물 끝에 '소정의 수수료를 제공받을 수 있음'이라는 문구만 적어주시면, {nickname}님만의 힙한 콘텐츠 무드를 전혀 해치지 않으면서도 실질적인 판매 수익을 챙기실 수 있습니다. :)

진행 방식이나 수수료율 등 논의할 부분이 있으시다면 언제든 편하게 회신 부탁드립니다.
감사합니다.
박혜란 드림"""
        },
        'seeding': {
...
평소 올려주시는 감각적인 데일리룩을 보며, 저희 어퍼(UPPR)의 제품을 {nickname}님만의 스타일로 꼭 한번 소화해 주셨으면 하는 마음에 제품 시딩(협찬)을 제안드립니다. 

**[제공 제품: 어퍼 시그니처 아이템]**
{nickname}님의 핏을 더욱 돋보이게 해 줄 베스트 아이템을 선물로 보내드립니다.

- UPPR 제품 중 원하시는 제품 선물
- 제품 확인: https://a-bly.com/app/markets/107175/

본 시딩은 제품을 착용하시고 인스타그램(피드 또는 릴스)에 판매 링크 삽입, 공식 계정(@uppr_official) 태그와 함께 1회 업로드해 주시는 형태로 진행됩니다. 딱딱한 리뷰 형식은 절대 필요 없으며, 평소 즐겨 입으시는 옷에 저희 제품을 가볍게 툭 매치해서 힙하고 편안한 '꾸안꾸룩'으로 보여주시면 충분합니다! 

게시물 업로드 시 정보를 궁금해할 팔로워분들을 위한 '전용 최저가 수익 링크'도 같이 발행해 드릴 수 있습니다. 쿠팡 파트너스처럼 프로필이나 본문에 링크만 걸어두시면 판매 시 쿠팡보다 훨씬 높은 브랜드 직영 수수료가 {nickname}님 통장으로 정산됩니다.

예쁜 아웃핏 자랑하시면서, 영향력에 걸맞은 실질적인 수익(리워드)도 꼭 함께 챙겨가셨으면 좋겠습니다! :) 
...
평소 {nickname}님의 건강하고 긍정적인 라이프스타일을 유심히 보며, 저희 브랜드가 추구하는 ‘지속 가능한 건강한 다이어트’의 방향성과 완벽한 시너지가 날 것 같아 연락드렸습니다. 

**[브랜드 및 제품 경쟁력]**
단 3일 만에 14,000포가 판매될 만큼 수많은 고객님이 맛과 포만감을 인정한 아이템입니다. 

- **비린맛/텁텁함 ZERO:** 영양성분이 좋으면 맛이 없다는 편견을 깬 완벽한 '속세의 맛'
- **입터짐 방지 & 든든함:** 씹히는 토핑과 단백질 20g으로, 묽지 않고 한 잔만으로 배부른 완벽한 한 끼 대용식
- 제품 확인: https://zigzag.kr/catalog/products/168991502?utm_source=shopping_naver_all&tab=detail

**[협업 제안 내용]**
이미 확실한 판매 데이터가 존재하는 제품인 만큼, {nickname}님과 전용 링크를 통한 수익 쉐어(RS) 공동구매를 최우선으로 제안드리고 싶습니다

하지만 캘린더 일정상 본격적인 공동구매 진행이 부담스러우시다면, 인스타그램 프로필 링크나 게시물 하단에 '단독 최저가 링크'만 가볍게 걸어두시는 방식도 함께 제안해 드립니다. 

운영 방식은 쿠팡 파트너스와 동일하지만, 본사 직영인 만큼 수수료율이 훨씬 높습니다. 14,000포가 팔려나간 대란템이기에, 기존 콘텐츠 무드를 해치지 않으면서 링크 하나만으로도 실질적인 큰 수익을 챙기실 수 있습니다. :)

관련하여 궁금하신 사항은 편하게 회신 부탁드립니다.
감사합니다.
박혜란 드림"""
        },
        'seeding': {
...
평소 {nickname}님의 콘텐츠를 보며 특유의 매력적인 분위기에 푹 빠진 팬입니다. 저희 브랜드가 지향하는 이미지와 너무 잘 어우러지실 것 같아, 이번 대란 제품을 꼭 챙겨드리고 싶어 연락드렸습니다.

**[시딩 제품: 쏙쉐이크 본품 세트]**
단 3일 만에 14,000포가 판매될 만큼 수많은 고객님이 맛과 포만감을 인정한 아이템입니다. 

- 배고프고 맛없는 다이어트는 그만: 텁텁함과 비린맛을 완벽하게 잡은 속세의 맛
- 씹는 맛이 살아있는 든든함: 단백질 20g, 한 잔만으로 배부른 한 끼 대용식
- 제품 확인: https://zigzag.kr/catalog/products/168991502?utm_source=shopping_naver_all&tab=detail

이번 시딩은 직접 넉넉하게 드셔보시고, {nickname}만의 감성으로 인스타그램(또는 블로그)에 판매 링크 삽입(+공식 계정 @sssockshake 태그 등) 가볍게 노출(1회)해 주시는 일정입니다. 

정보를 궁금해할 구독자분들을 위해 '전용 최저가 수익 링크'도 함께 발행해 드릴게요! 운영 방식은 쿠팡 파트너스와 동일하게 프로필이나 본문에 링크만 걸어두시면 됩니다. 어차피 맛있는 일상 피드를 올리시면서, 브랜드 직영의 높은 수수료를 통해 실질적인 수익(리워드)도 함께 챙겨가셨으면 좋겠습니다. :)
