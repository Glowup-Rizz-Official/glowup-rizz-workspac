...
정보를 궁금해할 구독자분들을 위해 '전용 최저가 링크'도 함께 발행해 드릴게요. 운영 방식은 쿠팡 파트너스와 동일하게 프로필이나 본문에 링크만 걸어두시면 되는 아주 간단한 방식입니다. 브랜드 직영인 만큼 쿠팡보다 훨씬 높은 수수료를 챙겨드리고 있으니, '소정의 수수료를 제공받을 수 있음'이라는 문구 하나만 가볍게 곁들여서 영향력에 걸맞은 실질적인 수익(리워드)도 꼭 챙겨가셨으면 좋겠습니다. :)
...
제품 확인하기
https://a-bly.com/app/markets/107175/
...
제품 착용 후 OOTD를 공유해 주실 때, 정보를 궁금해할 구독자분들을 위해 '전용 최저가 링크'도 함께 발행해 드릴게요. 운영 방식은 쿠팡 파트너스와 동일하게 프로필이나 본문에 링크만 걸어두시면 되는 아주 간단한 방식입니다. 브랜드 직영인 만큼 쿠팡보다 훨씬 높은 수수료를 챙겨드리고 있으니, '소정의 수수료를 제공받을 수 있음'이라는 문구 하나만 가볍게 곁들여서 영향력에 걸맞은 실질적인 수익(리워드)도 꼭 챙겨가셨으면 좋겠습니다. :)
...
평소 크리에이터님의 영상을 즐겨 보고 있었습니다. 저희 브랜드가 추구하는 ‘지속 가능한 다이어트’의 방향성과 시너지가 크게 날 것 같아, 수익 쉐어형 커머스(공구)를 제안드리고자 연락드렸습니다.
...
https://zigzag.kr/catalog/products/168991502?utm_source=shopping_naver_all&tab=detail

[협업 제안 내용]
협업 형태: 인플루언서 전용 링크를 통한 판매 수익 쉐어 (RS)
특별 혜택: 첫 런칭 기념 한정 수량 무료배송 프로모션 지원 가능 (팬분들의 구매 전환율 극대화)
플랫폼: 지그재그, 자사몰 등 협의 가능

단순히 1회성으로 소비되는 광고를 넘어, 크리에이터님과 팬분들 모두 만족하고 윈윈할 수 있는 커머스 파트너십을 맺고 싶습니다.
관련하여 문의사항은 편하게 유선 연락 부탁드립니다.
...
제품 받아보시고 크리에이터님만의 감성으로 인스타그램(또는 블로그)에 판매 링크, 브랜드 계정(@ssockshake)태그와 함께 피드 노출만 부탁드리고 싶습니다. :)
정보를 궁금해할 구독자분들을 위해 '전용 최저가 링크'도 함께 발행해 드릴게요. 운영 방식은 쿠팡 파트너스와 동일하게 프로필이나 본문에 링크만 걸어두시면 되는 아주 간단한 방식입니다. 브랜드 직영인 만큼 쿠팡보다 훨씬 높은 수수료를 챙겨드리고 있으니, '소정의 수수료를 제공받을 수 있음'이라는 문구 하나만 가볍게 곁들여서 영향력에 걸맞은 실질적인 수익(리워드)도 꼭 챙겨가셨으면 좋겠습니다. :)
