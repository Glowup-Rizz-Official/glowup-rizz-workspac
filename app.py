...
관련하여 문의 사항이나 미팅 일정을 잡고자 하신다면 편하게 유선 연락 부탁드립니다.
...
정해진 틀이나 형식에 얽매이기보다는, 평소 크리에이터님이 보여주시는 예쁜 감성 그대로 묻어나지 않는 립타투와 투명한 립시럽의 시너지를 자연스럽게 담아주시면 됩니다!
...
관련하여 상세 제안서 확인이 필요하시거나 논의할 부분이 있으시다면 언제든 편하게 유선 연락 부탁드립니다.
...
딱딱한 리뷰 형식보다는, 평소 크리에이터님이 즐겨 입으시는 데일리룩에 가볍게 툭 매치해서 힙하고 편안한 꾸안꾸룩으로 연출해 주시면 정말 좋을 것 같습니다.:)
